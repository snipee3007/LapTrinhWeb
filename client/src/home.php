      ...
      <div class="max-w-5xl 2xl:max-w-6xl">
        ...
        <div class="mb-10 grid grid-cols-6 gap-2 font-semibold">
          <?php 
              $list = [
                  ...
                  ['name' => 'Bàn phím', 'link' => 'keyboard.php', 'image' => 'https://file.hstatic.net/200000837185/file/gaming_gear_b4b15044a0dd49febc5e6f818667fd39_compact.png'],
              ];
              for ($i = 0; $i < count($list); $i++) {
                echo '<a href='. $list[$i]['link'] .' class="flex flex-col items-center justify-center text-center cursor-pointer hidden md:block mx-auto">
        ...
        <div class="rounded-lg p-4 mb-10 shadow-md bg-white">
          ...
          <div class="flex justify-between items-center mb-3">
            <div class="text-sm font-semibold">
              <?php
                echo "Hiển thị " . $countPC . " sản phẩm"
              ?>
            </div>
            <a href="pc.php" class="p-2 text-white rounded-lg text-sm bg-gray-900 border border-white hover:text-black hover:bg-white hover:border-gray-900 transition-colors duration-300 ease-in-out">Xem tất cả sản phẩm >></a>
          </div>
        </div>
        ...
        <div class="rounded-lg p-4 mb-10 shadow-md bg-white">
          ...
          <div class="flex justify-between items-center mb-3">
            ...
            <a href="laptop.php" class="p-2 text-white rounded-lg text-sm bg-gray-900 border border-white hover:text-black hover:bg-white hover:border-gray-900 transition-colors duration-300 ease-in-out">Xem tất cả sản phẩm >></a>
          </div>
        ...
        <div class="rounded-lg p-4 mb-10 shadow-md bg-white">
          ...
          <div class="flex justify-between items-center mb-3">
            ...
            <a href="screen.php" class="p-2 text-white rounded-lg text-sm bg-gray-900 border border-white hover:text-black hover:bg-white hover:border-gray-900 transition-colors duration-300 ease-in-out">Xem tất cả sản phẩm >></a>
          </div>
        </div>
        ...
        <div class="rounded-lg p-4 mb-10 shadow-md bg-white">
          ...
          <div class="flex justify-between items-center mb-3">
            <div class="text-sm font-semibold">
              <?php
                echo "Hiển thị " . $countHeadphone . " sản phẩm"
              ?>
            </div>
            <a href="headphone.php" class="p-2 text-white rounded-lg text-sm bg-gray-900 border border-white hover:text-black hover:bg-white hover:border-gray-900 transition-colors duration-300 ease-in-out">Xem tất cả sản phẩm >></a>
          </div>
        </div>
        ...
        <div class="rounded-lg p-4 mb-10 shadow-md bg-white">
          ...
          <div class="flex justify-between items-center mb-3">
            <div class="text-sm font-semibold">
              <?php
                echo "Hiển thị " . $countKeyboard . " sản phẩm"
              ?>
            </div>
            <a href="keyboard.php" class="p-2 text-white rounded-lg text-sm bg-gray-900 border border-white hover:text-black hover:bg-white hover:border-gray-900 transition-colors duration-300 ease-in-out">Xem tất cả sản phẩm >></a>
          </div>
        </div>
        ...
        <div class="rounded-lg p-4 mb-10 shadow-md bg-white">
          ...
          <div class="flex justify-between items-center mb-3">
            <div class="text-sm font-semibold">
              <?php
                echo "Hiển thị " . $countMouse . " sản phẩm"
              ?>
            </div>
            <a href="mouse.php" class="p-2 text-white rounded-lg text-sm bg-gray-900 border border-white hover:text-black hover:bg-white hover:border-gray-900 transition-colors duration-300 ease-in-out">Xem tất cả sản phẩm >></a>
          </div>
        </div>
      </div>
