  ...
  <div class="max-w-screen-2xl mx-auto" style='font-family: Victor Mono'>
    <div class="flex flex-row justify-center">
      ...
      <div class="max-w-5xl 2xl:max-w-6xl">
        ...
        <div x-data="{ openLogin: false, openReg: false }" class="rounded-lg shadow-lg p-4 mb-10 bg-white">
            ...
            if (isset($_SESSION['hash_id'])){
              ...
              <div class="col-span-1">
                  <div class="rounded-full w-12 h-12 overflow-hidden border-2 border-gray">
                      <img src="'. $CUSTOM_PATH . $currentUser['Image'] .'" alt="'. $currentUser['Name'] . '" class="object-cover w-full h-full">
                  </div>
              </div>
              ...
              echo '<button type="button" id="resetStars" class="text-sm mt-1 ml-2 hover:underline text-blue-700">Đặt lại</button>
                  </div>
                  ...
                  ';
              include_once 'components/commentPopup.php';
              echo'    </div>
                </div>
              </div>
          </div>
              ...
              echo '<div x-cloak x-show="openReg" x-transition:enter="transition ease-out duration-200 transform" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-200 transform" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-90" class="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50">';
