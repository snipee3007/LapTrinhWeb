                    ...
                    <div class="col-span-2">
                        <div class="rounded-lg shadow-md p-4 bg-white">
                            ...
                            <a href='./../../server/Logout.php'>
                                <button type="button" id="signoutButton" class="text-sm flex items-center hover:text-blue-700">
                                    <svg class="w-6 h-6 text-gray-800 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    ...
                    <div class="col-span-4">
                        <div id="profile" class="rounded-lg shadow-md p-4 bg-white">
                            ...
                            <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method='post'>
                                ...
                                <button type="submit" id="submit_change" class="w-full p-2 text-white rounded-lg text-xs bg-blue-700 border border-white hover:text-blue-700 hover:bg-white hover:border-blue-700 transition-colors duration-300 ease-in-out">Lưu thay đổi</button>
                            </form>
                        </div>
                        <?php
                            include_once("./../../connect_db.php");
                                ...
                                try{
                                    ...
                                    if(empty($emaillErr)){
                                        ...
                                        if(mysqli_query($con, $query)){
                                            ...
                                            // echo "<p class='text-green-600 alert'>Record was updated.</p>";
                                        }else{
                                            echo '<script>
                                            document.querySelector("#submit_change").addEventListener("click", async function(e){
                                            ...
                                            // echo "<p class='text-red-600 alert'>Unable to save record.</p>";
                                        }
                                    }
                                    else{
...
<!-- <script src='./controller/delete_record.js'></script> -->
</html>
