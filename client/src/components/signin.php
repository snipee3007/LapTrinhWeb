<div x-data="{openLogin: false}">
    <button type="button" class="w-full rounded-lg bg-blue-700 text-white p-2.5 mb-2.5" x-on:click="openLogin = true">Đăng nhập</button>

    <div class="flex items-center justify-center min-h-screen" x-cloak x-show="openLogin">
        <form class="bg-white rounded-lg border p-5" style="font-family: Space Mono; width: 500px">
            ...
            <div class="flex justify-between">
                ...
                <div>
                <button type="button" class="-m-2.5 rounded-md p-2.5 text-gray-700" x-on:click="openLogin = false">
            ...
            <p class="text-center">Bạn chưa có tài khoản? <a href="#" class="text-blue-500 hover:underline">Đăng ký ngay</a>!</p>
