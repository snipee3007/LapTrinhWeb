<header x-data="{open: false}" @keydown.window.escape="open = false" class="bg-gray-900">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div x-data="{openLogin: false, openReg: false}" class="z-50">
            <button type="button" x-on:click="openLogin = true" class="font-bold leading-6 text-white flex items-center gap-x-1">
                <span>
        ...
        <a href="#" class="font-bold leading-6 text-white flex items-center gap-x-1">
            <span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentcolor" class="w-6 h-6">
    ...
    <div class="lg:hidden" role="dialog" aria-modal="true" x-show="open">
        ...
        <div class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10" @click.away="open = false">
        ...
        <div class="mt-6 flow-root">
            ...
            <div class="space-y-2 py-6">
                <a href="about.php" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-50">Giới thiệu</a>
                <a href="news.php" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-50">Tin tức</a>
                <a href="about.php#store" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-50">Hệ thống cửa hàng</a>
                <a href="tel:000-000-0000" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-50">Liên hệ</a>
            </div>
            <div class="py-6">
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white hover:bg-gray-50">Đăng nhập</a>
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white hover:bg-gray-50">Giỏ hàng</a>
            </div>
            </div>
        </div>
        </div>
