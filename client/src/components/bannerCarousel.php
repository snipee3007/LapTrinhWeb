<div id="default-carousel" class="relative w-full h-full hidden md:block" data-carousel="slide">
    <div class="relative overflow-hidden rounded-lg h-[700px]">
        <div class="duration-700 ease-in-out h-1/2" data-carousel-item>
            <img src="images/banner1.jpg" class="w-full" alt="Banner1">
        </div>
        <div class="absolute top-0 duration-700 ease-in-out h-1/2" data-carousel-item>
            <img src="images/banner2.png" class="w-full" alt="Banner2">
        </div>
        <div class="absolute top-0 duration-700 ease-in-out h-1/2" data-carousel-item>
            <img src="images/banner3.jpg" class="w-full" alt="Banner3">
        </div>
    </div>
</div>