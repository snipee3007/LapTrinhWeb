...
<div class="relative"> 
        <div class="bg-gray-900 text-white text-sm rounded-lg px-2 hidden md:block w-full">
            <div class="grid grid-cols-10 gap-1 navbarContainer">
                <div data-name="pc" class="py-2 navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer">
                ...
                <div data-name="laptop" class="py-2 navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer">
                ...
                <div data-name="screen" class="py-2 navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer">
                ...
                <div data-name="cpu-vga" class="py-2 navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentcolor" class="w-8 h-8 mb-2">
                ...
                <div data-name="case" class="py-2 navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentcolor" class="w-8 h-8 mb-2">
                ...
                <div data-name="component" class="py-2 navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer">
                ...
                <div data-name="headphone" class="py-2 navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer">
                ...
                <div data-name="keyboard" class="py-2 navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer" x-on:mouseenter="openType = Array(10).fill(false); openType[7] = true">
                ...
                <div data-name="mouse" class="py-2 navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer" x-on:mouseenter="openType = Array(10).fill(false); openType[8] = true">
                ...
                <div data-name="speaker" class="py-2 navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer" x-on:mouseenter="openType = Array(10).fill(false); openType[9] = true">
        ...
        <div data-name="pc" class="hiddenNavbar bg-white w-full cursor-pointer rounded-lg shadow-lg p-6 absolute z-50 hidden">
            <div class="grid grid-cols-4 gap-4">
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">i3 (từ 7 triệu)</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">i5 (từ 10 triệu)</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">i7 (từ 27 triệu)</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">i9 (từ 40 triệu)</a>
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">R3 (từ 5 triệu)</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">R5 (từ 7 triệu)</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">R7 (từ 37 triệu)</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">R9 (từ 40 triệu)</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Xem tất cả</a>
                    </li>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">PC RTX 1650</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">PC RTX 2060</a>
                    </li>
                    <li>
        ...
        <div data-name="laptop" class="hiddenNavbar bg-white w-full cursor-pointer rounded-lg shadow-lg p-6 absolute z-50 hidden">
            <div class="grid grid-cols-4 gap-4">
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">Dưới 15 triệu</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Từ 15-20 triệu</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Trên 20 triệu</a>
                    </li>
                </ul>
                </div>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">Đồ họa - Studio</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Học sinh - sinh viên</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Văn phòng</a>
                    </li>
                </ul>
                </div>
        ...
        <div data-name="screen" class="hiddenNavbar bg-white w-full cursor-pointer rounded-lg shadow-lg p-6 absolute z-50 hidden">
            <div class="grid grid-cols-4 gap-4">
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">Dưới 5 triệu</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Từ 5-10 triệu</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Từ 10-20 triệu</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Từ 20-30 triệu</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Trên 30 triệu</a>
                    </li>
                </ul>
                </div>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">Màn hình 22"</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Màn hình 24"</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Màn hình 27"</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Màn hình 29"</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Màn hình 32" trở lên</a>
                    </li>
                </ul>
                </div>
                ...
                <ul>
                    ...
                    <li>
                    <a href="#" class="hover:text-blue-700">Màn hình 2K 1440p</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Màn hình 4K UHD</a>
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">Curved 24"</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Curved 27"</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Curved 29"</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Curved 32" trở lên</a>
                    </li>
                </ul>
                </div>
            </div>
        ...
        <!-- CPU - VGA -->
        <div data-name="cpu-vga" class="hiddenNavbar bg-white w-full cursor-pointer rounded-lg shadow-lg p-6 absolute z-50 hidden">
            <div class="grid grid-cols-4 gap-4">
                <div>
                ...
                <ul>
                    ...
                    <li>
                    <a href="#" class="hover:text-blue-700">RTX 4060 Ti</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">RTX 4070</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">RTX 4070 Super</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">RTX 4070 Ti</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">RTX 4070 Ti Super</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">RTX 4080</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">RTX 4080 Super</a>
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                    <a href="#" class="hover:text-blue-700">RTX 2060 </a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">GTX 1660 Super</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">GTX 1650</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Quadro series</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Xem tất cả</a>
                    </li>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">Core i3-13th</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Core i5-11th</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Core i5-12th</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Core i5-13th</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Core i7-11th</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Core i7-12th</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Core i7-13th</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Core i9-13th</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Core i9-14th</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Xem tất cả</a>
                    </li>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">AMD Ryzen 3</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">AMD Ryzen 5</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">AMD Ryzen 7</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">AMD Ryzen 9</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">AMD Athlon</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">AMD Threadripper</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Xem tất cả</a>
                    </li>
        ...
        <!-- Case - nguồn -->
        <div data-name="case" class="hiddenNavbar bg-white w-full cursor-pointer rounded-lg shadow-lg p-6 absolute z-50 hidden">
            <div class="grid grid-cols-4 gap-4">
                <div>
                ...
                <ul>
                    ...
                    <li>
                    <a href="#" class="hover:text-blue-700">Lianli</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">NZXT</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Xem tất cả</a>
                    </li>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">Dưới 1 triệu</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Từ 1-2 triệu</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Trên 2 triệu</a>
                    </li>
                </ul>
                </div>
                ...
                <ul>
                    ...
                    <li>
                    <a href="#" class="hover:text-blue-700">DeepCool</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Corsair</a>
                    </li>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">Từ 400w - 500w</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Từ 500w - 600w</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Từ 700w - 800w</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Trên 1000w</a>
                    </li>
                </ul>
                </div>
            </div>
        ...
        <!-- Linh kiện -->
        <div data-name="component" class="hiddenNavbar bg-white w-full cursor-pointer rounded-lg shadow-lg p-6 absolute z-50 hidden">
            <div class="grid grid-cols-4 gap-4">
                <div>
                ...
                <ul>
                    ...
                    <li>
                    <a href="#" class="hover:text-blue-700">64 GB</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Xem tất cả</a>
                    </li>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">DDR4</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">DDR5</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Xem tất cả</a>
                    </li>
                ...
                <ul>
                    ...
                    <li>
                    <a href="#" class="hover:text-blue-700">Kingston</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Xem tất cả</a>
                    </li>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">HDD 1TB</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">HDD 2TB</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">HDD 4TB - 6TB</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">HDD 8TB trở lên</a>
                    </li>
                </ul>
                </div>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">Seagate</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Toshiba</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Western Digital</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Xem tất cả</a>
                    </li>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">SSD 20GB - 128GB</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">SSD 250GB - 256GB</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">SSD 480GB - 512GB</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">SSD 960GB - 1TB</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">SSD 2TB</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">SSD 2TB trở lên</a>
                    </li>
                </ul>
                </div>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">Sandisk</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Xem tất cả</a>
                    </li>
        ...
        <div data-name="headphone" class="hiddenNavbar bg-white w-full cursor-pointer rounded-lg shadow-lg p-6 absolute z-50 hidden">
            <div class="grid grid-cols-4 gap-4">
                ...
                <ul>
                    ...
                    <li>
                    <a href="#" class="hover:text-blue-700">Từ 2-3 triệu</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Từ 3-4 triệu</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Trên 4 triệu</a>
                    </li>
                </ul>
                </div>
                ...
                <ul>
                    ...
                    <li>
                    <a href="#" class="hover:text-blue-700">Bluetooth</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Headphone</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">In-ear</a>
                    </li>
                </ul>
                </div>
            </div>
        ...
        <div data-name="keyboard" class="hiddenNavbar bg-white w-full cursor-pointer rounded-lg shadow-lg p-6 absolute z-50 hidden">
            <div class="grid grid-cols-4 gap-4">
                ...
                <ul>
                    ...
                    <li>
                    <a href="#" class="hover:text-blue-700">Receiver</a>
                    </li>
                </ul>
                </div>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">Bàn phím cơ</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Bàn phím văn phòng</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Bàn phím Tablet</a>
                    </li>
                </ul>
                </div>
            </div>
        ...
        <div data-name="mouse" class="hiddenNavbar bg-white w-full cursor-pointer rounded-lg shadow-lg p-6 absolute z-50 hidden">
            <div class="grid grid-cols-4 gap-4">
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">Dưới 500k</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Từ 500k - 1 triệu</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Từ 1 triệu - 2 triệu</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Từ 2 triệu - 3 triệu</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Trên 3 triệu</a>
                    </li>
                </ul>
                </div>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">Chuột Gaming</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Chuột văn phòng</a>
                    </li>
                </ul>
                </div>
            </div>
        ...
        <!-- Loa -->
        <div data-name="speaker" class="hiddenNavbar bg-white w-full cursor-pointer rounded-lg shadow-lg p-6 absolute z-50 hidden">
            <div class="grid grid-cols-4 gap-4">
                <div>
                <div class="font-bold mb-2">Hãng sản xuất</div>
                <ul>
                    ...
                    <li>
                    <a href="#" class="hover:text-blue-700">SoundMax</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Edifier</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">JBL</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Xem tất cả</a>
                    </li>
                ...
                <ul>
                    <li>
                    <a href="#" class="hover:text-blue-700">Loa vi tính</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Loa Bluetooth</a>
                    </li>
                    <li>
                    <a href="#" class="hover:text-blue-700">Loa Soundbar</a>
                    </li>
                </ul>
                </div>
            </div>
