    ...
    <div class="relative"> 
        <div class="bg-gray-900 text-white text-sm rounded-lg px-2 hidden md:block w-full">
            <div class="grid grid-cols-10 gap-1 navbarContainer">
                <div data-name="pc" class="navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer">
                ...
                <div data-name="laptop" class="navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer">
                ...
                <div data-name="screen" class="navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer">
                ...
                <div data-name="cpu-vga" class="navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentcolor" class="w-8 h-8 mb-2">
                ...
                <div data-name="case" class="navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentcolor" class="w-8 h-8 mb-2">
                ...
                <div data-name="component" class="navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer">
                ...
                <div data-name="headphone" class="navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer">
                ...
                <div data-name="keyboard" class="navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer" x-on:mouseenter="openType = Array(10).fill(false); openType[7] = true">
                ...
                <div data-name="mouse" class="navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer" x-on:mouseenter="openType = Array(10).fill(false); openType[8] = true">
                ...
                <div data-name="speaker" class="navbarItem flex flex-col items-center text-center hover:underline decoration-2 cursor-pointer" x-on:mouseenter="openType = Array(10).fill(false); openType[9] = true">
