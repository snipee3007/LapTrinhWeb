<header x-data="{open: false}" @keydown.window.escape="open = false" class="bg-gray-900">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <a href="#" class="user_buy font-bold leading-6 text-white flex items-center gap-x-1">
            <span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentcolor" class="w-6 h-6">
    ...
    <div class="lg:hidden" role="dialog" aria-modal="true" x-show="open">
        ...
        <div class="mt-6 flow-root">
            ...
            <div class="py-6">
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white hover:bg-gray-50 hover:text-black">Đăng nhập</a>
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white hover:bg-gray-50 hover:text-black">Giỏ hàng</a>
            </div>
            </div>
        </div>
        </div>
